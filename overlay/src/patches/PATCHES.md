...
save() の DB 更新後、ローカル履歴スナップショット、ファイル関連付け open-file の useEffect を追加。詳細は PATCHES_FULL.md 参照。

## 3. src/components/EditorHeader/ControlPanel.jsx
File メニュー拡張、ローカル履歴ブラウザ、履歴から復元、i18n(EN/JA)対応。詳細は PATCHES_FULL.md 参照。
